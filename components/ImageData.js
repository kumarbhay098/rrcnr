        ...
        <>
            <div className="flex gap-1 justify-center overflow-x-auto mt-4">
                ...
                <div className="flex-shrink-0 w-80">
                    ...
                    <h3 className="text-center font-bold text-md mt-2">श्री अश्विनी वैष्णव
                        माननीय रेल मंत्री</h3>
                </div>
                <div className="flex-shrink-0 w-80">
                    <Image src={'/min2.jpg'} width={300} height={200} className="object-cover" alt="Minister Image 2" />
                    <h3 className="text-center font-bold text-md mt-2">श्री वी. सोमन्ना
                        माननीय रेल राज्य मंत्री</h3>
                </div>
                <div className="flex-shrink-0 w-80">
                    <Image src={'/min3.jpg'} width={300} height={200} className="h-96 object-cover" alt="Minister Image 3" />
                    <h3 className="text-center font-bold text-md mt-2">श्री रवनीत सिंह
